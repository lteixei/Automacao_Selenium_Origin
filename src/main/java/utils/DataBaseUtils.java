...
public class DataBaseUtils {
    ...
    public static Connection newBSCSIXConnection() {
        try {
            ...
            String portNumber = "", host = "", url = "", username = "", password = "", nameService = "";
    ...
    public static Connection newSiebelPreUAT1Connection() {
        try {
            ...
            connect = DriverManager.getConnection(url, username, password);
            System.out.println("Sucesso ao conectar no BD do SIEBEL PRE - UAT1");
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
        } catch (SQLException e) {
            System.out.println("Ops, erro ao conectar no BD!");
    ...
    public static Connection newSiebelUAT1Connection() {
        try {
            ...
            password = "siebel";
            connect = DriverManager.getConnection(url, username, password);
            System.out.println("Sucesso ao conectar no BD do SIEBEL POS - UAT1");
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
        } catch (SQLException e) {
            System.out.println("Ops, erro ao conectar no BD!");
    ...
    public static Connection newSiebelUAT2Connection() {
        try {
            ...
            password = "siebel";
            connect = DriverManager.getConnection(url, username, password);
            System.out.println("\n" + "Sucesso ao conectar no BD do SIEBEL PRE - UAT2");
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
        } catch (SQLException e) {
            System.out.println("Ops, erro ao conectar no BD!");
    ...
    public ResultSet executeAndReturnAllResults(String sql, Connection connect) {
        try {
            Statement query = connect.createStatement();
            System.out.print("Executando busca: " + sql);
            // Executa Script
